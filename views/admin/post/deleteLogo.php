<?php
/*
    SUPPRESSION DU LOGO D'UN POST (Traitement uniquement, utilisé sur les bouttons Supprimer des logo dans post/edit.php)
*/
...
$filePath = 'assets/uploads/logo/'. $logo->getName();
